                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col text-center">
                                ...
                                <h2 class="page-heading">Reach Us</h2>
                            </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <!--    <h3>Head Office</h3>-->
                            <!--    <address class="s1">-->
                            <!--        <span class="d-flex"><i class="id-color fa fa-map-marker fa-lg"></i>Demo Address-->
                            <!--            Colony, , Coimbatore, Tamilnadu, India, 600028</span>-->
                            <!--        <span><i class="id-color fa fa-phone fa-lg"></i><a href="tel:+911234567890">+91-->
                            <!--                12345 67890</a></span>-->
                            ...
                            <!--                href="https://Demo-home.Demo.net/DemoBrand Broucher.pdf"-->
                            ...
                            <div class="padding40 text-light box-rounded" style="background-color:#20254c;">
                                ...
                                <address class="s1">
                                    ...
                                    <span><i class="fa fa-file-pdf-o fa-lg"></i><a
                                            href="https://perseveremedica.com/Eco_Broucher.pdf"
                                            target="_blank">Download Brochure</a></span>
                                </address>
                            </div>
                        ...
                        <div class="col-lg-8">
                            <h3>Kindly fill in your enquiry here</h3>

                            <form id="contact_form" class="form-border" method="POST" action="mail.php">
                                ...
                                <div id="submit">
                                    <input type="submit" name="sendmail" value="Submit Form"
                                        style="background-color:#20254c;" class="btn btn-custom" /> <br><br>
                                </div>
