                ...
                <div class="container d-flex justify-content-center">
                    ...
                    <div class="pre-nxt-btn">
                        <button type="button" class="btn btn-bg-color btn-sm">
                            <a href="perblast.php" style="color:#000;"><i class="id-color arrow_left fa-lg"
                                     style="margin-right: 5px"></i>Previous</a>
                        </button>
                        <p class="mx-3 mb-0">14/15</p>
                        <button type="button" class="btn btn-bg-color btn-sm">
                            <a href="beniper4.php" style="color:#000;">Next<i class="id-color arrow_right fa-lg"
                            ...
                            <div class="row">
                                    ...
                                    <div class="d-flex" style="flex-direction: column; justify-content: center">
                                        <div class="prod-detail-mob mt-4 ">
                                            <h4 style="font-size: 26px; font-family:'Montserrat-Black'; margin-bottom: 0;"
                                                class="prd-big-head"> PERCORTISONE 10mg</h4>
                                            <p style="margin-bottom: 5px;">(Hydrocortisone)</p>
                                            <p style="font-size: 18px; font-style: italic; margin-bottom: 10px;">
                                                "Precision in Hydrocortisone Therapy."
                                            </p>
                                        </div>
                                        ...
                                        <div>
                                            <div class="tab-content-container mb-5" id="pills-tabContent">
                                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                                    ...
                                                    <img src="../images/product/percortisone.jfif" width="190"
                                                        height="auto" onerror="this.src='images/product/product-2.webp'"/>
                                                </div>
                                            </div>
                                                ...
                                                <ul class="nav nav-pills mt-1" id="pills-tab" role="tablist">
                                                    <li class="nav-item">
                                                        <a class="avail-type active" id="pills-home-tab"
                                                            ...
                                                            aria-controls="pills-home" aria-selected="true">10x10(10’s) Tablets</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="prod-detail-desk">
                                        ...
                                        <p style="margin-bottom: 5px;">(Hydrocortisone)</p>
                                        <p style="font-size: 18px; font-style: italic; margin-bottom: 10px;">
                                            "Reliable Support for Corticosteroid Needs."
                                        </p>
                                    </div>
                                    <div class="ul-list">
                                        <ul style="margin-left: 15px; list-style-type: disc; ">
                                            <li>Adrenal insufficiency treatment</li>
                                            <li>Severe allergic reactions</li>
                                            <li>Arthritis and joint inflammation</li>
                                            <li>Skin conditions and immune disorders</li>
                                        </ul>
                                    </div>

                                    <ul style="list-style-type: none;font-size: 14px;padding-left: 0px;margin-top: 30px;">
                                        <li>
                                            <img src="../images/product/icons/nasal-spray.gif" class="img-fluid icon-prd" />
                                            Packing: 10x10(10’s)
                                        </li>
                                        <li>
