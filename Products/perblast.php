                ...
                <div class="container d-flex justify-content-center">
                    ...
                    <div class="pre-nxt-btn">
                        <button type="button" class="btn btn-bg-color btn-sm">
                            <a href="amlovere-h.php" style="color:#000;"><i class="id-color arrow_left fa-lg"
                                    style="margin-right: 5px"></i>Previous</a>
                        </button>
                        <p class="mx-3 mb-0">13/15</p>
                        <button type="button" class="btn btn-bg-color btn-sm">
                            <a href="percortisone.php" style="color:#000;">Next<i class="id-color arrow_right fa-lg"
                                    ...
                                    <div class="d-flex" style="flex-direction: column; justify-content: center">
                                        <div class="prod-detail-mob mt-4 ">
                                            <h4 style="font-size: 26px; font-family:'Montserrat-Black'; margin-bottom: 0;"
                                                class="prd-big-head"> PERBLAST - M</h4>
                                            <p style="margin-bottom: 5px;">(Bilastine 20 mg + Montelukast 10 mg)</p>
                                        ...
                                        <div>
                                            <div class="tab-content-container mb-5" id="pills-tabContent">
                                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                                    ...
                                                    <img src="../images/product/perblast-m.jfif" width="190"
                                                        height="auto" />
                                                </div>
                                            </div>
        ...
        <section class="py-0">
            <div class="container d-flex justify-content-center">
                ...
                <div class="pre-nxt-btn">
                    ...
                    <p class="mx-3 mb-0">13/15</p>
                    <button type="button" class="btn btn-bg-color btn-sm">
                        <a href="lamzomid-ns.php" style="color:#000;">Next<i class="id-color arrow_right fa-lg"
                                style="margin-right: 5px"></i></a>
                    </button>
                </div>
            </div>
