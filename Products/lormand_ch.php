                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 mob-prd">
                                    <div class="d-flex" style="flex-direction: column; justify-content: center">
                                        <div class="prod-detail-mob mt-4 ">
                                            <p style="margin-bottom: 5px;">(Losartan 50mg + Chlorthalidone 12.5 mg)</p>
                                            <h4 style="font-size: 26px; font-family:'Montserrat-Black'; margin-bottom: 0;"
                                                class="prd-big-head"> LORMAND CH</h4>
                                            <p style="font-size: 18px; font-style: italic; margin-bottom: 10px;">
                                                "Inspired by Science. Proven for Control"
                                            </p>
                                        </div>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <p style="font-size: 12px; font-style: italic; margin-top: 20px;">
                                        We thank Robert Adolph Armand Tigerstedt for his invaluable contribution to medical science.
                                    </p>
