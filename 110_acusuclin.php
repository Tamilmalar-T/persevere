        ...
        <div class="container d-flex justify-content-center">
          ...
          <div class="pre-nxt-btn">
            <button type="button" class="btn btn-bg-color btn-sm">
              <a href="kentrela.php" style="color: #000"><i class="id-color arrow_left fa-lg"
                  style="margin-right: 5px"></i>Previous</a>
            </button>
            <p class="mx-3 mb-0">10/52</p>
            <button type="button" class="btn btn-bg-color btn-sm">
              <a href="vacranium.php" style="color: #000">Next<i class="id-color arrow_right fa-lg"
            ...
            <div class="col-lg-8 col-md-12 pt10">
              <div class="row">
                ...
                <!-- <span class="bredcrm"><a href="product.html"><i class="id-color arrow_left fa-lg"
                                            style="margin-right: 5px"></i>Acusuclin</a></span> -->
                ...
                <div class="col-lg-6 col-md-6 d-flex mob-prd" style="flex-direction: column; justify-content: center">
                  <div class="prod-detail-mob mt-4">
                    ...
                    <p style="font-size: 22px; font-family: 'Swiss721-cn-BT'">
                      ...
                      <!--<span class="avail-size" style="font-size: 16px"> 50mg/ml</span>-->
                    </p>
                  </div>
                  <div>
                    <div class="tab-content tab-content-container mb-5" id="pills-tabContent">
                      <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                        ...
                        <img src="images/product/19. Acusuclin.webp" width="370" height="auto" />
                      </div>
                    </div>
                      ...
                      <ul class="nav nav-pills mt-1" id="pills-tab" role="tablist">
                        <li class="nav-item">
                          <a class="avail-type active" id="pills-home-tab" data-toggle="pill" href="#pills-home"
                            role="tab" aria-controls="pills-home" aria-selected="true">10ml Vial</a>
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div class="col-lg-6 col-md-6">
                  ...
                  <div class="ul-list">
                    ...
                    <ul>
                      <li>
                        Drug of choice in emergencies where immediate airway
                        management is required<sup style="font-size:8px;">1</sup>
                      </li>
                      <li>
                        In surgical procedures when abdominal wall muscle
                        disruption is necessary<sup style="font-size:8px;">1</sup>
                      </li>
                      <li>For rapid endotracheal intubation<sup style="font-size:8px;">1</sup></li>
                      <li>Treatment of acute laryngospasm²</li>
                    </ul>
                  </div>
                  ...
                  <ul style="
                      ...
                      ">
                      <li>
                      <img src="images/product/icons/UV protected by Amber glass.png" class="img-fluid icon-prd" />Amber
                      coloured vial
                    </li>
                    <li>
                  ...
                  <!-- <div class="pre-nxt-btn pt-3">
                                        <button type="button" class="btn btn-warning btn-sm">
                                            <a href="kentrela.html" style="color:#000;"><i class="id-color arrow_left fa-lg" style="margin-right: 5px"></i>Previous</a>
                                        </button>
                                        <p class="mx-3 mb-0">12/56</p>
                                        <button type="button" class="btn btn-warning btn-sm">
                                            <a href="mayocron.html" style="color:#000;">Next<i class="id-color arrow_right fa-lg" style="margin-right: 5px"></i></a>
                                        </button>
                                    </div> -->
                </div>
              </div>
            ...
            <div class="col-lg-4 col-md-12 video-resp">
              <div class="">
                <video autoplay muted loop width="100%" height="auto">
                  <source src="images/product/product video/Acusuclin.m4v" type="video/mp4" />
                </video>
              </div>
              <div class="ol-list">
                <ol style="list-style-type: decimal; font-size: 10px">
                  <li>
                    Hager HH, et al. Succinylcholine Chloride Treasure Island
                    StstPearls Publishing 2022
                  </li>
                  <li>
                    Bohringer C, etv al. Transl Perioper Pain
                    Med.2019;6(4):129-135
                  </li>
                </ol>
              </div>
            </div>
