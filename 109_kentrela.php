        ...
        <div class="container d-flex justify-content-center">
          ...
          <div class="pre-nxt-btn">
            <button type="button" class="btn btn-bg-color btn-sm">
              <a href="proactfol-mct.php" style="color: #000"><i class="id-color arrow_left fa-lg"
                  style="margin-right: 5px"></i>Previous</a>
            </button>
            <p class="mx-3 mb-0">9/52</p>
            <button type="button" class="btn btn-bg-color btn-sm">
              <a href="acusuclin.php" style="color: #000">Next<i class="id-color arrow_right fa-lg"
              ...
              <div class="row">
                ...
                <div class="col-lg-6 col-md-6 d-flex mob-prd" style="flex-direction: column; justify-content: center">
                  <div class="prod-detail-mob mt-4">
                    <h4 style="font-size: 26px; font-family: 'Montserrat-Black'" class="prd-big-head">
                      Kentrela<sup>®</sup> <span class="avail-size">(5ml/10ml)</span>
                    </h4>
                  ...
                  <div class="tab-content-container">
                    <div class="tab-content" data-content-index="0">
                      <img src="images/product/17. Kentrela 5ml.webp" width="380" height="auto" />
                    </div>
                    <div class="tab-content" data-content-index="1">
                      <img src="images/product/18. Kentrela 10ml.webp" width="380" height="auto" />
                    </div>
                  </div>
                ...
                <div class="col-lg-6 col-md-6">
                  ...
                  <div class="ul-list">
                    ...
                    <ul>
                      <li>
                        Sole agent in short-term medical procedures that do
                        not require skeletal muscle relaxation<sup style="font-size:8px;">1</sup>
                      </li>
                      <li>
                        Induction of general anaesthesia as a pre-anaesthetic²
                      </li>
                      <li>
                        Safe adjunct analgo-sedative agent with no negative
                        impact²
                      </li>
                    </ul>
                  </div>
            ...
            <div class="col-lg-4 col-md-12 video-resp">
              <div class="">
                <video autoplay muted loop width="100%" height="auto">
                  <source src="images/product/product video/kentrela.mp4" type="video/mp4" />
                </video>
              </div>
              <div class="ol-list">
                <ol style="list-style-type: decimal; font-size: 10px">
                  <li>
                    Rosenbaum SB, et al. Ketamine. In StatPearls Treasure
                    Island
                  </li>
                  <li>Amer M, et al. J Intensive care 9, 54(2021)</li>
                </ol>
              </div>
            </div>
          </div>
