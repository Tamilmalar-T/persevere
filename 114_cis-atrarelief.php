        ...
        <div class="container d-flex justify-content-center">
          ...
          <div class="pre-nxt-btn">
            <button type="button" class="btn btn-bg-color btn-sm">
              <a href="rocstable.php" style="color: #000"><i class="id-color arrow_left fa-lg"
                  style="margin-right: 5px"></i>Previous</a>
            </button>
            <p class="mx-3 mb-0">14/52</p>
            <button type="button" class="btn btn-bg-color btn-sm">
              <a href="acustigmine.php" style="color: #000">Next<i class="id-color arrow_right fa-lg"
            ...
            <div class="col-lg-8 col-md-12 pt10">
              <div class="row">
                ...
                <!-- <span class="bredcrm"><a href="product.php"><i class="id-color arrow_left fa-lg"
                                            style="margin-right: 5px"></i>Cis-atrarelief</a></span> -->
                ...
                <div class="col-lg-6 col-md-6 d-flex mob-prd" style="flex-direction: column; justify-content: center">
                  <div class="prod-detail-mob mt-4">
                    <h4 style="font-size: 26px; font-family: 'Montserrat-Black'" class="prd-big-head">
                      Cis-Atrarelief<sup>®</sup>  <span class="avail-size">(5ml/10ml)</span>
                    </h4>
                    <p style="font-size: 22px; font-family: 'Swiss721-cn-BT'">
                      Cisatracurium Besylate Injection U.S.P. 
                      <!--<span class="avail-size" style="font-size:16px">(2mg/ml)</span>-->
                    </p>
                  </div>
                  <div class="tab-content-container">
                    <div class="tab-content" data-content-index="0">
                      <img src="images/product/27. Cisatracurium 5ml.webp" width="370" height="auto" />
                    </div>
                    <div class="tab-content" data-content-index="1">
                      <img src="images/product/28. Cisatracurium 10ml.webp" width="370" height="auto" />
                    </div>
                  </div>
                ...
                <div class="col-lg-6 col-md-6">
                  ...
                  <div class="ul-list">
                    <h6>Indications</h6>
                    <ul>
                      <li>3 times more potent then Artacurium<sup style="font-size:8px;">1</sup></li>
                      <li>Better renal and hepatic safety profile²</li>
                      <li>Better Hemodynamic stability³</li>
                      <li>
                        In ICU care setting to facilitate mechanical
                        ventilation <small><sup>4</sup></small>
                      </li>
                    </ul>
                  </div>
                  ...
                  <ul style="
                    ...
                    <li>
                      ...
                      5ml Single Dose Vial & 10ml Multi Dose Vial
                    </li>
                    <li>
                  ...
                  <!-- <div class="pre-nxt-btn pt-3">
                                        <button type="button" class="btn btn-warning btn-sm">
                                            <a href="rocstable.php" style="color:#000;"><i class="id-color arrow_left fa-lg" style="margin-right: 5px"></i>Previous</a>
                                        </button>
                                        <p class="mx-3 mb-0">18/56</p>
                                        <button type="button" class="btn btn-warning btn-sm">
                                            <a href="acustigmine.php" style="color:#000;">Next<i class="id-color arrow_right fa-lg" style="margin-right: 5px"></i></a>
                                        </button>
                                    </div> -->
                </div>
              </div>
            ...
            <div class="col-lg-4 col-md-12 video-resp">
              <div class="">
                <video autoplay muted loop width="100%" height="auto">
                  <source src="images/product/product video/Cis-Astrarelief.m4v" type="video/mp4" />
                </video>
              </div>
              <div class="ol-list">
                <ol style="list-style-type: decimal; font-size: 10px">
                  <li>
                    Ortiz JR et al. Rev Esp Anaestesiol Reanim.
                    1998;45(6):242-247
                  </li>
                  <li>
                    Strawbridge AD, et al. Cisatracurium. In StatPearls.
                    Treasure Island Publishing 2022
                  </li>
                  <li>
                    Martin JL. CH. 24, Miller's Anaesthesia. Ed: Miller RD, 7th
                    Edition. 2010; 633-662
                  </li>
                  <li>
                    Strawbridge AD, et al. Cisatracurium. Updated 2021 Jul 13
                  </li>
                </ol>
              </div>
            </div>
