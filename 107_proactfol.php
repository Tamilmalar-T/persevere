        ...
        <div class="container d-flex justify-content-center">
          ...
          <div class="pre-nxt-btn">
            <button type="button" class="btn btn-bg-color btn-sm">
              <a href="acrolate.php" style="color: #000"><i class="id-color arrow_left fa-lg"
                  style="margin-right: 5px"></i>Previous</a>
            </button>
            <p class="mx-3 mb-0">7/52</p>
            <button type="button" class="btn btn-bg-color btn-sm">
              <a href="proactfol-mct.php" style="color: #000">Next<i class="id-color arrow_right fa-lg"
              ...
              <div class="row">
                ...
                <div class="col-lg-6 col-md-6 d-flex mob-prd" style="flex-direction: column; justify-content: center">
                  <div class="prod-detail-mob mt-4">
                    <h4 style="font-size: 26px; font-family: 'Montserrat-Black'" class="prd-big-head">
                      Proactfol<sup>®</sup> <span class="avail-size">(10ml/20ml/50ml)</span>
                    </h4>
                  ...
                  <div class="tab-content-container">
                    <div class="tab-content" data-content-index="0">
                      <img src="images/product/11. Proactfol 10ml.webp" width="400" height="auto" />
                    </div>
                    <div class="tab-content" data-content-index="1">
                      <img src="images/product/12. Proactfol 20ml.webp" width="400" height="auto" />
                    </div>
                    <div class="tab-content" data-content-index="1">
                      <img src="images/product/13. Proactfol 50ml.webp" width="400" height="auto" />
                    </div>
                  </div>
                ...
                <div class="col-lg-6 col-md-6">
                  ...
                  <div class="ul-list">
                    ...
                    <ul>
                      <li>
                        Induction and Maintenance of General Anaesthesia<sup style="font-size:8px;">1</sup>
                      </li>
                      <li>
                        Sedation in mechanically ventilated patients, with
                        rapid wake-up time²
                      </li>
                      <li>In treatment of Status Epilepticus³</li>
                      <li>
            ...
            <div class="col-lg-4 col-md-12 video-resp">
              <div class="">
                <video autoplay muted loop width="100%" height="auto">
                  <source src="images/product/product video/proactfol.mp4" type="video/mp4" />
                </video>
              </div>
              <div class="ol-list">
                <ol style="list-style-type: decimal; font-size: 10px">
                  <li>
                    Robert FL, et al. Anaesthesia. 1988;43 Suppl:14 - 17
                  </li>
                  <li>
                    Kress JP, et al. Am J Respir Crit Care Med.
                    1996;153(3):1012-1018
                  </li>
                  <li>Hwang WS, et al. J Epilepsy Res. 2013;3(l):21-27</li>
                  <li>Kampo S, et al. BMC Anaesthesiol 19, 177 (2019)</li>
                </ol>
                <p style="font-size: 10px;margin-top:-9px;">*PONV: Post Operative Nausea and Vomiting</p>
              </div>
            </div>
          </div>
        </div>
