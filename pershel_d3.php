                ...
                <div class="container d-flex justify-content-center">
                    ...
                    <div class="pre-nxt-btn">
                        <button type="button" class="btn btn-bg-color btn-sm">
                            <a href="duloxalin_75.php" style="color:#000;"><i class="id-color arrow_left fa-lg"
                                     style="margin-right: 5px"></i>Previous</a>
                        </button>
                        <p class="mx-3 mb-0">10/16</p>
                        <button type="button" class="btn btn-bg-color btn-sm">
                            <a href="esovere_40.php" style="color:#000;">Next<i class="id-color arrow_right fa-lg"
                                ...
                                <div class="col-lg-6 col-md-6 mob-prd">
                                    <div class="d-flex" style="flex-direction: column; justify-content: center">
                                        <div class="prod-detail-mob mt-4 ">
                                            <p style="margin-bottom: 5px;">In Vitamin D3 Deficiency</p>
                                            <h4 style="font-size: 26px; font-family:'Montserrat-Black'; margin-bottom: 0;"
                                                class="prd-big-head"> PERSHEL - D3</h4>
                                            <p style="margin-bottom: 5px;">Vitamin D3 60000 IU Chewable Tablets</p>
                                        ...
                                        <div>
                                            <div class="tab-content-container mb-5" id="pills-tabContent">
                                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                                    ...
                                                    <img src="images/product/pershel-d3.jfif" width="190"
                                                        height="auto" />
                                                </div>
                                            </div>
                                                ...
                                                <ul class="nav nav-pills mt-1" id="pills-tab" role="tablist">
                                                    <li class="nav-item">
                                                        <a class="avail-type active" id="pills-home-tab"
                                                            ...
                                                            aria-controls="pills-home" aria-selected="true">4 Tablets
                                                            per each Strip</a>
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    <ul
                                        ...
                                        <li style="display: flex; align-items: flex-start; margin-bottom: 15px;">
                                            ...
                                            <span>
                                                ...
                                                Each Chewable Tablet Contains : Vitamin D3 60000 IU
                                            </span>
                                        </li>
                                    </ul>
