...
<body class="hide-rtl">
    ...
    <div class="col-lg-3 col-md-4 col-6 ">
      <a href="../Products/lormand_ch.php" class="text-decoration-none">
        <div class="product-box">
          <img src="../images/product/lormand-ch.jfif" alt="">
          <h4>lORMAND CH</h4>
        </div>
      </a>
    </div>
    ...
    <!-- Product 2 -->
    <div class="col-lg-3 col-md-4 col-6">
      <a href="../Products/amlovere-h.php" class="text-decoration-none">
        <div class="product-box">
          <img src="../images/product/amlovere-h.jfif" alt="">
          <h4>AMLOVERE H</h4>
        </div>
      </a>
    </div>
    ...
    <div class="col-lg-3 col-md-4 col-6">
      <a href="../Products/pershel_d3.php" class="text-decoration-none">
        <div class="product-box">
          <img  src="../images/product/beniper_4.jpeg" alt="">
          <h4>BENIPER 4</h4>
        </div>
      </a>
    </div>
