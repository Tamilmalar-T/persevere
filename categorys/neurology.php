...
<body class="hide-rtl">
    ...
    <div class="col-lg-3 col-md-4 col-6 ">
      <a href="../Products/duloxalin_75.php" class="text-decoration-none">
        <div class="product-box">
          <img src="../images/product/duloxalin.jfif" alt="">
          <h4>DULOXALINE 75/20</h4>
        </div>
      </a>
    </div>
    ...
    <!-- Product 2 -->
    <div class="col-lg-3 col-md-4 col-6">
      <a href="../Products/percoba-pg.php" class="text-decoration-none">
        <div class="product-box">
          <img src="../images/product/percoba-pg.jfif" alt="">
          <h4>PERCOBA PG</h4>
        </div>
      </a>
    </div>
