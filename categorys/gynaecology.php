...
<body class="hide-rtl">
    ...
    <!-- Product 2 -->
    <div class="col-lg-3 col-md-4 col-6">
      <a href="../Products/percoba.php" class="text-decoration-none">
        <div class="product-box">
          <img src="../images/product/Percoba.jfif" alt="">
          <h4>PERCOBA - 1</h4>
        </div>
      </a>
    </div>
    ...
    <!-- Product 3 -->
    <div class="col-lg-3 col-md-4 col-6">
      <a href="../Products/pershel500.php" class="text-decoration-none">
        <div class="product-box">
          <img src="../images/product/pershel500.jfif" alt="">
          <h4>PERSHEL 500</h4>
        </div>
      </a>
    </div>
