...
<body class="hide-rtl">
    <div id="wrapper">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="de-flex sm-pt10">
                            ...
                            <div class="de-flex-col">
                                 <div class="h-phone"><span>Need&nbsp;Help?</span><i class="fa fa-phone id-color-secondary"></i> 1 600 100 0000</div>
        ...
        <div class="no-bottom no-top" id="content">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col text-center">
                                ...
                                <h2 class="page-heading">About  Company</h2>
                            </div>
            ...
            <section class="abt-sec" aria-label="section" data-bgcolor="#ffffff"
