...
<a href="product.php" class="back-btn"><i class="fa fa-arrow-left"></i> BACK</a>                              
                              <h4>DERMOTOLOGY PRODUCTS</h4>
                              
                              <div class="row">
                               
                                <!--Product 1: PERPLAST-M-->
                                <div class="col-lg-2 col-md-4 col-12 product-view pt20">
                                  <div class="product-disp">
                                    <div class="product-img">
                                      <a href="15_perblast.php"><img   src="images/product/perblast-m.jfif" class="img-fluid" /></a>
                                    </div>
                                    <a href="03_percobapg.php">
                                      <h6 class="text-center text">PERPLAST-M</h6>
