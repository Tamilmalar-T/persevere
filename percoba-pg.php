                ...
                <div class="container d-flex justify-content-center">
                    ...
                    <div class="pre-nxt-btn">
                        <button type="button" class="btn btn-bg-color btn-sm">
                            <a href="percoba.php" style="color:#000;"><i class="id-color arrow_left fa-lg"
                                     style="margin-right: 5px"></i>Previous</a>
                        </button>
                        <p class="mx-3 mb-0">3/16</p>
                        <button type="button" class="btn btn-bg-color btn-sm">
                            <a href="Persride_m1.php" style="color:#000;">Next<i class="id-color arrow_right fa-lg"
                                    ...
                                    <div class="d-flex" style="flex-direction: column; justify-content: center">
                                        <div class="prod-detail-mob mt-4 ">
                                            <h4 style="font-size: 26px; font-family:'Montserrat-Black'; margin-bottom: 0;"
                                                class="prd-big-head"> Percoba-PG</h4>
                                        ...
                                        <div>
                                            <div class="tab-content-container mb-5" id="pills-tabContent">
                                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                                    ...
                                                    <img src="images/desktop/percoba-pg.png" width="190"
                                                        height="auto" />
                                                </div>
                                            </div>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <ul
                                        ...
                                        <li style="display: flex; align-items: flex-start; margin-bottom: 15px;">
                                            ...
                                            <span>
                                                Pharmacopoeia - I.P. Pregabalin 75mg, Methylcobalamin 1000mcg, ALA
                                                100mg, Benfotiamine 50mg, Folic acid 5mg, pyridoxine 10mg, Inositol
                                                100mg<br>
