...
<link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css" rel="stylesheet">
        ...
        .product-list li a:hover{
            ...
            box-shadow:0 4px 10px rgba(49,51,128,0.3);
        }
            ...
            <div class="col-lg-2 col-md-3">
                ...
                <div class="left-menu">
                    ...
                    <ul class="product-list">
                        ...
                        <li>
                            <a href="01_pershel500.php" target="productFrame">
                                1. Pershel 500
                            </a>
                        </li>

                        <li>
                            <a href="02_percoba.php" target="productFrame">
                                2. Percoba
                            </a>
                        </li>

                        <li>
                            <a href="03_percobapg.php" target="productFrame">
                                3. Percobapg
                            </a>
                        </li>

                        <li>
                            <a href="04_persride-m1.php" target="productFrame">
                                4. Persride M1
                            </a>
                        </li>

                        <li>
                            <a href="05_persride-m2.php" target="productFrame">
                                5. Persride M2
                            </a>
                        </li>
