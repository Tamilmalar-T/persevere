        ...
        <div class="container d-flex justify-content-center">
          ...
          <div class="pre-nxt-btn">
            <button type="button" class="btn btn-bg-color btn-sm">
              <a href="cloncure.php" style="color: #000"><i class="id-color arrow_left fa-lg"
                  style="margin-right: 5px"></i>Previous</a>
            </button>
            <p class="mx-3 mb-0">5/52</p>
            <button type="button" class="btn btn-bg-color btn-sm">
              <a href="acrolate.php" style="color: #000">Next<i class="id-color arrow_right fa-lg"
              ...
              <div class="row">
                ...
                <div class="col-lg-6 col-md-6 d-flex mob-prd" style="flex-direction: column; justify-content: center">
                  <div class="prod-detail-mob mt-4">
                    ...
                    <p style="font-size: 22px; font-family: 'Swiss721-cn-BT'">
                      ...
                      <!--<span class="avail-size" style="font-size:16px">0.6mg/ml</span>-->
                    </p>
                  </div>
                  ...
                  <div>
                    <div class="tab-content  tab-content-container mb-5" id="pills-tabContent">
                      <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                        ...
                        <img src="images/product/9. Cutropin.webp" width="400" height="auto" />
                      </div>
                    </div>
                      ...
                      <ul class="nav nav-pills mt-1" id="pills-tab" role="tablist">
                        <li class="nav-item">
                          <a class="avail-type active" id="pills-home-tab" data-toggle="pill" href="#pills-home"
                            role="tab" aria-controls="pills-home" aria-selected="true">1ml Ampoule</a>
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div class="col-lg-6 col-md-6">
                  ...
                  <div class="ul-list">
                    ...
                    <ul>
                      <li>First-line therapy for symptomatic bradycardia<sup style="font-size:8px;">1</sup></li>
                      <li>Second-line therapy in treatment of diarrehea<sup style="font-size:8px;">1</sup></li>
                      <li>
                        In anti-vagal effect, organophosphate poisoning<sup style="font-size:8px;">1</sup>
                      </li>
                      <li>Neostigmine overdosage²</li>
                    </ul>
                  </div>
                  ...
                  <!-- <div class="pre-nxt-btn pt-3">
                                        <button type="button" class="btn btn-warning btn-sm">
                                            <a href="cloncure.php" style="color:#000;"><i class="id-color arrow_left fa-lg" style="margin-right: 5px"></i>Previous</a>
                                        </button>
                                        <p class="mx-3 mb-0">7/56</p>
                                        <button type="button" class="btn btn-warning btn-sm">
                                            <a href="acrolate.php" style="color:#000;">Next<i class="id-color arrow_right fa-lg" style="margin-right: 5px"></i></a>
                                        </button>
                                    </div> -->
                </div>
              </div>
            ...
            <div class="col-lg-4 col-md-12 video-resp">
              <div class="">
                <video autoplay muted loop width="100%" height="auto">
                  <source src="images/product/product video/Cutropin.m4v" type="video/mp4" />
                </video>
              </div>
              <div class="ol-list">
                <ol style="list-style-type: decimal; font-size: 10px">
                  <li>McLendon K, et al.Atropine StatPearls</li>
                  <li>Neely GA, et al. Neostigmine. StatPeals</li>
                </ol>
              </div>
            </div>
          </div>
