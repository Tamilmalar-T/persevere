                ...
                <div class="container d-flex justify-content-center">
                    ...
                    <div class="pre-nxt-btn">
                        <button type="button" class="btn btn-bg-color btn-sm">
                            <a href="atrarelief.php" style="color:#000;"><i class="id-color arrow_left fa-lg"
                                    style="margin-right: 5px"></i>Previous</a>
                        </button>
                        <p class="mx-3 mb-0">13/52</p>
                        <button type="button" class="btn btn-bg-color btn-sm">
                            <a href="cis-atrarelief.php" style="color:#000;">Next<i class="id-color arrow_right fa-lg"
                ...
                <div id="prd-detail" class="container-fluid" style="padding: 0px 0px 0px 70px">
                    <div class="row no-gutters">
                        <div class="col-lg-8 col-md-12 pt10">
                            <div class="row">
                                <!--Product display-->
                                <h4><a href="product.php" class="text-black"><i class="id-color arrow_left fa-lg" style="margin-right: 5px"></i> ANAESTHESIA</a></h4>
                                <!-- <span class="bredcrm"><a href="product.php"><i class="id-color arrow_left fa-lg"
                                            style="margin-right: 5px"></i>Rocstable </a></span> -->

                                <div class="col-lg-6 col-md-6 d-flex mob-prd"
                                    ...
                                    <div class="prod-detail-mob mt-4">
                                        ...
                                        <p style="font-size: 22px; font-family: 'Swiss721-cn-BT'">
                                            ...
                                            <!--<span class="avail-size" style="font-size:16px">(50mg/5ml & 100mg/10ml)</span>-->
                                        </p>
                                    </div>
                                    <div class="tab-content-container">
                                        <div class="tab-content" data-content-index="0">
                                            <img src="images/product/25. Rocstable 50.webp" width="360" height="auto" />
                                        </div>
                                        <div class="tab-content" data-content-index="1">
                                            <img src="images/product/26. Rocstable 100.webp" width="360"
                                                height="auto" />
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="ul-list">
                                        ...
                                        <ul>
                                            <li>
                                                Provides airway muscle paralysis to facilitate
                                                endotracheal intubation<sup style="font-size:8px;">1</sup>
                                            </li>
                                            <li>
                                                Provides surgical paralysis to facilitate
                                                surgery<sup style="font-size:8px;">1</sup>
                                            </li>
                                            <li>
                                                Provides chest wall relaxation to facilitate
                                                mechanical ventilation<sup style="font-size:8px;">1</sup>
                                            </li>
                                            <li>
                                                Provides better acceptable intubation condition²
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="row pt-2">
                                        <div class="col-12">
                                            <!--<h5>Rocstable - 50 & Rocstable - 100</h5>-->
                                            <ul
                                        ...
                                        <!-- <div class="col-lg-6 col-md-6 col-sm-12">
                                            <h5>Rocstable - 100</h5>
                                    <ul style="list-style-type: none;font-size: 14px;padding-left: 0px;margin-top: 10px;">
                                        <li>
                                    ...
                                    <!-- <div class="pre-nxt-btn pt-3">
                                        <button type="button" class="btn btn-warning btn-sm">
                                            <a href="atrarelief.php" style="color:#000;"><i class="id-color arrow_left fa-lg" style="margin-right: 5px"></i>Previous</a>
                                        </button>
                                        <p class="mx-3 mb-0">17/56</p>
                                        <button type="button" class="btn btn-warning btn-sm">
                                            <a href="cis-atrarelief.php" style="color:#000;">Next<i class="id-color arrow_right fa-lg" style="margin-right: 5px"></i></a>
                                        </button>
                                    </div> -->
                        ...
                        <div class="col-lg-4 col-md-12 video-resp">
                            <div class="">
                                <video autoplay muted loop width="100%" height="auto">
                                    <source src="images/product/product video/rocstable.mp4" type="video/mp4" />
                                </video>
                            </div>
                            <div class="ol-list">
                                <ol style="list-style-type: decimal; font-size: 10px">
                                    <li>
                                        Jain A, et al. Rocuronium. In StatPearls Treasure Island Publishing 2022 Jan
                                    </li>
                                    <li>
                                        Parasa M, et al. Anesth Essays Res. 2015;9(1):88-91
                                    </li>
                                </ol>
                            </div>
                        </div>
