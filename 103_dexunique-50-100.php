        ...
        <div class="container d-flex justify-content-center">
          ...
          <div class="pre-nxt-btn">
            <button type="button" class="btn btn-bg-color btn-sm">
              <a href="lamzomid.php" style="color: #000"><i class="id-color arrow_left fa-lg"
                  style="margin-right: 5px"></i>Previous</a>
            </button>
            <p class="mx-3 mb-0">3/52</p>
            <button type="button" class="btn btn-bg-color btn-sm">
              <a href="cloncure.php" style="color: #000">Next<i class="id-color arrow_right fa-lg"
            ...
            <div class="col-lg-8 col-md-12 pt10">
              <div class="row">
                ...
                <!-- <span class="bredcrm"><a href="product.php"><i class="id-color arrow_left fa-lg"
                                            style="margin-right: 5px"></i>Kentrela</a></span> -->
                ...
                <div class="col-lg-6 col-md-6 d-flex mob-prd" style="flex-direction: column; justify-content: center">
                  <div class="prod-detail-mob mt-4">
                    <h4 style="font-size: 26px; font-family: 'Montserrat-Black'" class="prd-big-head">
                      Dexunique<sup>®</sup> <span class="avail-size">(50/100)</span>
                    </h4>
                  ...
                  <div class="tab-content-container">
                    <div class="tab-content" data-content-index="0">
                      <img src="images/desktop/6.Dexunique0.5ml.png" width="380" height="auto" />
                    </div>
                    <div class="tab-content" data-content-index="1">
                      <img src="images/product/7. Dexunique 1ml.webp" width="380" height="auto" />
                    </div>
                  </div>

                  <h6>Available As:</h6>
                  <div class="tab-container" id="tabContainer">
                    <div class="tab" data-tab-index="0">50mcg/0.5ml Ampoule</div>
                    <div class="tab" data-tab-index="1">100mcg/ml Ampoule</div>
                  </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6">
                  ...
                  <div class="ul-list">
                    ...
                    <ul>
                      <li>
                        Promising sedative with favourable respiratory profile<sup style="font-size:8px;">1</sup>
                      </li>
                      <li>
                        Reduces opioids and anaesthetic requirement²
                      </li>
                      <li>
                        Ensures patient compatibility during clinical examination³
                      </li>
                      <li>Associated with more desired level of awake sedation<sup style="font-size:8px;">4</sup>
                      </li>
                      <li>
                          Significantly reduces the use of<sup style="font-size:8px;">5</sup>
                      </li>
                      <div>
                        <div class="row">
                          <div class="col-6">
                          ...
                          <div class="col-6">
                            <ul>
                              <li>Antiemetics</li>
                              <li>Epinephrine and Diuretics</li>
                            </ul>
                          </div>
                        </div>
                      </div>
                  ...
                  <ul style="
                    ...
                    <li>
                      ...
                      1 × 0.5ml Ampoule & 1 × 1ml Ampoule
                    </li>
                    <li>
                      <img src="images/product/icons/Strength icon.gif" class="img-fluid icon-prd" />50mcg/0.5ml &
                      100mcg/ml
                    </li>
                    <li>
                  ...
                  <!-- <div class="pre-nxt-btn pt-3">
                                        <button type="button" class="btn btn-warning btn-sm">
                                            <a href="proactfol-mct.php" style="color:#000;"><i class="id-color arrow_left fa-lg" style="margin-right: 5px"></i>Previous</a>
                                        </button>
                                        <p class="mx-3 mb-0">11/56</p>
                                        <button type="button" class="btn btn-warning btn-sm">
                                            <a href="acusuclin.php" style="color:#000;">Next<i class="id-color arrow_right fa-lg" style="margin-right: 5px"></i></a>
                                        </button>
                                    </div> -->
                </div>
              </div>
            ...
            <div class="col-lg-4 col-md-12 video-resp">
              <div class="">
                <video autoplay muted loop width="100%" height="auto">
                  <source src="images/product/product video/Dexunique.m4v" type="video/mp4" />
                </video>
              </div>
              <div class="ol-list">
                <ol style="list-style-type: decimal; font-size: 10px">
                  <li>Can J Gastroentero L 2007;21:25-29</li>
                  <li>Drug R D 2006; 43-52</li>
                  <li>Burns.2010;36: 501-55</li>
                  <li>Intern Med 51:2299-2305,2012</li>
                  <li>Current Opinion in Anaesthesiology 2007,20: 119-123</li>
                </ol>
              </div>
            </div>
          </div>
